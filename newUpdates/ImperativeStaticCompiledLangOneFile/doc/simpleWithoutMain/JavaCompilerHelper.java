...
public class JavaCompilerHelper {
 ...
 public static class ByteBuffer {
     ...
     public void appendByte(int b) {
         ...
         elems[length++] = (byte)b;
         System.out.println("CompilerWriter: Appending to Buffer : appendByte : val=" + b);
     }
     ...
     public void appendChar(int x) {
         ...
         length = length + 2;
         System.out.println("CompilerWriter: Appending to Buffer : appendChar : val=" + x);
     }
     ...
     public void appendInt(int x) {
         ...
         length = length + 4;
         System.out.println("CompilerWriter: Appending to Buffer : appendInt : val=" + x);
     }
